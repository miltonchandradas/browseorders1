...
sap.ui.define(["sap/ui/model/type/Currency"], function (Currency) {
  ...
  return {
     ...
     */
    currencyValue: function currencyValue(sValue) {
      if (!sValue) {
        return "";
      }
     ...
     * @returns {string} formatted currency value with 2 digits
     */
    calculateItemTotal: function calculateItemTotal(iQuantity, fPrice, sCurrencyCode) {
     ...
     */
    handleBinaryContent: function handleBinaryContent(vData) {
      if (vData) {
     ...
     */
    deliveryText: function deliveryText(oRequiredDate, oShippedDate) {
     ...
     */
    deliveryState: function deliveryState(oRequiredDate, oShippedDate) {
      if (oShippedDate === null) {
        return "None";
      } // delivery is urgent (takes more than 7 days)
