...
sap.ui.define(["sap/ui/base/Object", "sap/m/MessageBox"], function (UI5Object, MessageBox) {
  ...
  return UI5Object.extend("sap.ui.demo.orderbrowser.controller.ErrorHandler", {
     ...
     */
    constructor: function constructor(oComponent) {
      ...
      this._oModel.attachRequestFailed(function (oEvent) {
        var oParams = oEvent.getParameters(); // An entity that was not found in the service is also throwing a 404 error in oData.
     ...
     * @private
     */
    _showServiceError: function _showServiceError(sDetails) {
