...
sap.ui.define(["sap/ui/base/Object", "sap/base/Log"], function (BaseObject, Log) {
  ...
  return BaseObject.extend("sap.ui.demo.orderbrowser.controller.ListSelector", {
    ...
    constructor: function constructor() {
      ...
      }.bind(this)); // This promise needs to be created in the constructor, since it is allowed to
      ...
      this.oWhenListLoadingIsDone = new Promise(function (fnResolve, fnReject) {
        ...
        this._oWhenListHasBeenSet.then(function (oList) {
          oList.getBinding("items").attachEventOnce("dataReceived", function () {
    ...
    selectAListItem: function selectAListItem(sBindingPath) {
      this.oWhenListLoadingIsDone.then(function () {
        ...
        oSelectedItem = oList.getSelectedItem(); // skip update if the current selection is already matching the object path
